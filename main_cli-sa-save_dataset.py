...
##########################################################################################################################################
    ...
    path_self_assessment_h5 = os.path.join(path_self_assessment, 'dataset_for_training_sa.h5')
...
#                 if version_sa in [1,2,3,4,7,8,9]:
...
#                 print(np.count_nonzero(np.isnan(xdata_self_assessment[0][0])))
#                 print(np.count_nonzero(np.isnan(xdata_self_assessment[0][1])))
#                 print(np.count_nonzero(np.isnan(xdata_self_assessment[1])))
#                 print(np.shape(xdata_self_assessment[0][0]))
#                 print(np.shape(xdata_self_assessment[0][1]))
#                 print(np.shape(xdata_self_assessment[1]))
